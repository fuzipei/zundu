	...
	[988], {
		...
		6082: function(e, s, t) {
			...
			var l = t(7437),
				...
				c = t.n(n);
			s.default = () => {
				let [e, s] = (0, a.useState)(""), [t, n] = (0, a.useState)(""), [o, d] = (0, a.useState)(!0), [i, m] = (0, a.useState)(!1), [u, x] = (0, a.useState)(!1), h = () => {
					n(""), s(""), m(!1), x(!1)
				};
				return (0, l.jsx)("div", {
							...
							children: (0, l.jsxs)("div", {
								...
								children: [(0, l.jsxs)("p", {
									...
									children: ["这是一个尊嘟语和人语互相翻译的工具。可以把翻译出的尊嘟语发给你不好好说话的朋友。", (0, l.jsx)("br", {}), "本工具为", (0, l.jsx)("a", {
										...
										children: "zdjd"
									}), "的演示demo,原作者SnailSword", (0, l.jsx)("br", {}), "bug反馈请联系", (0, l.jsx)("a", {
										className: "underline",
										target: "_blank",
										href: "mailto:help@richdev.cn",
										children: "help@richdev.cn"
									}), "。"]
								}), (0, l.jsxs)("div", {
									className: "space-y-2",
									...
									children: (0, l.jsx)("button", {
										...
										onClick: () => {
											try {
												let s = o ? r.Z.encode(e) : r.Z.decode(e);
												if (!o && !r.Z.isZdjd(e)) throw Error("输入的不是合法的狗语，请重新输入");
												n(s), m(!1), x(!1)
											} catch (e) {
												m(!1), x(!0), s(""), n("")
											}
									...
									children: [(0, l.jsx)("label", {
										...
										children: [(0, l.jsx)("textarea", {
											...
											children: (0, l.jsx)("button", {
												type: "button",
												className: "inline-flex items-center px-3 py-1 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ".concat(i ? "bg-green-600" : "bg-gray-300"),
												onClick: () => {
													c()(t), m(!0), x(!1)
												},
												children: i ? "已复制" : "复制"
